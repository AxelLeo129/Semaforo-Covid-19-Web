...
<body id='page-top' class='politics_version'>
	...
	<section id='home' class='main-banner parallaxie' style='background: url(\"../../uploads/fondo-4.jpg\")'>
		<div class='heading'>");

        $cnx=mysqli_connect("localhost","root","","osani") or die("No se pude accesar a la base de datos con la base de datos");
$query1=$cnx->query("SELECT * from clientes");
echo("<center><table border='1' bgcolor='sky blue' cellspacing=\"0\" cellpadding=\"9\" border=\"0\"><tr><th>Nombre</th><th>Eventos asistidos</th><th>Familia</th><th>Donaciones</th><th>cantidad</th></tr>");
while($r=mysqli_fetch_array($query1))
{  echo("<tr>");

    echo("<td>".$r['nombre']."</td><td>".$r['eventos']."</td><td>".$r['familia']."</td><td>".$r['cantidad']."</td>");

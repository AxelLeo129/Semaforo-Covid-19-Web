...
$query1=$cnx->query("SELECT * from proveedores");
echo("<center><table border='1' bgcolor='sky blue' cellspacing=\"0\" cellpadding=\"9\" border=\"0\"><tr><th>Empresa</th><th>Representante</th><th>Producto</th><th>Cantidad</th><th>Tipo de proveedor</th></tr>");
while($r=mysqli_fetch_array($query1))
{  echo("<tr>");

    echo("<td>".$r['empresa']."</td><td>".$r['nombre']."</td><td>".$r['donacion']."</td><td>".$r['cantidad']."</td>");
    $tipo=($r["tipo"]==TRUE)? "Donador":"Proveedor";
    echo("<td>".$tipo."</td>");

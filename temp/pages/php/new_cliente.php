      ...
      <div class='container'>
        ...
        <div class='collapse navbar-collapse' id='navbarResponsive'>
          <ul class='navbar-nav text-uppercase ml-auto'>
			...
			<li class='nav-item'>
              <a class='nav-link js-scroll-trigger' href='../proveedores.html'>Proveedores</a>
            </li>
			<li class='nav-item'>
              <a class='nav-link js-scroll-trigger active' href='../clientes.html'>Clientes</a>
            </li>
			<li class='nav-item'>
...
$query2=$cnx->query("SELECT * FROM familias");
$esta=FALSE;
while($r=mysqli_fetch_array($query2)){
    if($r['apellidos']==$fecha){
        $esta=TRUE;
    }
}
if($esta){
$query1=$cnx->query("INSERT INTO clientes(eventos,nombre,producto,cantidad,familia) values ('$evento','$nombre','$producto',$cantidad,'$fecha')");
echo("<div class='heading'><h1 style='position: absolute;top: 150px;left: 35%;'>  Se ha registrado el cliente con exito   </h1 >");
}
else{
echo("<div class='heading'><h1 style='position: absolute;top: 150px;left: 35%;'>  No se ha encontrado la familia '".$fecha."' en la base de datos   </h1 >");
}

...
<body id='page-top' class='politics_version'>
      ...
      <div class='container'>
        ...
        <div class='collapse navbar-collapse' id='navbarResponsive'>
          <ul class='navbar-nav text-uppercase ml-auto'>
			...
			<li class='nav-item'>
              <a class='nav-link js-scroll-trigger active' href='../reg_fam.html'>Familia</a>
            </li>
          </ul>
        </div>
      </div>
	...
	<section id='home' class='main-banner parallaxie' style='background: url(\"../../uploads/fondo-3.jpg\")'>
		<div class='heading'><h1 style='position: absolute;top: 150px;left: 35%;'>  Se ha registrado la familia con exito   </h1 >	");
...
$query1=$cnx->query("INSERT INTO familias(apellidos) values ('$nombre')");
